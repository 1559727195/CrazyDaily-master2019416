...
import 'dart:async';
import 'dart:convert';
import 'package:crazydaily_flutter/gankio_entity.dart';
import 'package:crazydaily_flutter/plugin/flutterrouter.dart';
      ...
      new GestureDetector(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: new Align(
                                alignment: Alignment.centerLeft,
                                child: new Text(
                                    "发布时间：${mGankioList[index].publishedAt ??
                                        "未知"}",
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    style: TextStyle(
        ...
        onTap: () {
          FlutterRouter.openUrl(
              "crazydaily://crazysunj.com/browser?url=${Uri.encodeComponent(
                  mGankioList[index].url)}");
        },
      ),
